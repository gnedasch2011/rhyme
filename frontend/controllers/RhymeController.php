...
//рандом из популярных
    ...
    {
        $this->view->title = 'Мужские рифмы | Как определить | Примеры стихов | Рифма.орг | Рифма.орг';
        $this->view->registerMetaTag(
            ['name' => 'description', 'content' => 'Что такое мужская рифма? Определение и примеры на ' . \Yii::$app->request->hostInfo]
        );
        $this->view->params['breadcrumbs'][] = array(
            'label' => 'Имена',
        );
    ...
    {
        $this->view->title = 'Женские рифмы | Как определить | Примеры стихов | Рифма.орг';
        $this->view->registerMetaTag(
            ['name' => 'description', 'content' => 'Что такое женская рифма? Определение и примеры на ' . \Yii::$app->request->hostInfo]
        );
        $this->view->params['breadcrumbs'][] = array(
            'label' => 'Имена',
        );
