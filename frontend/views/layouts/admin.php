    ...
    $menuItems = [
        ...
        ['label' => 'Общее',
            'items' => [
                ...
                ['label' => 'Видео', 'url' => ['/tasks/tasks']], //тут будет название дня, теория видео и сочетание упражнений
        ...
        ['label' => 'Конструктор предложений',
            'items' => [
                ...
                ['label' => 'Конструктор предложений', 'url' => ['/type_exercises/sentence']],//вопросы, тип теста, правильный вариант ответа
